                ...
                <div className='my-5'>
                    <div>
                        ...
                        <div className='mt-2'>
                            ...
                            type="text" 
                            name='name' 
                            className='w-full rounded-md border-0 py-1.5 text-secondary shadow-sm ring-1 ring-insert ring-gray-300 placeholder:text-gray-400 focus:ring-0 focus:ring-inset text-sm'/>
