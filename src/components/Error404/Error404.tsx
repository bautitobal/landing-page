...
export function Error404() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen text-center px-5">
            ...
            <h2 className="text-3xl mb-5">Lo sentimos, no se ha encontrado la propiedad que buscas.</h2>
            <Image src="/assets/404-not-found.jpg" alt="Error 404 Imágen, una casa hecha verga." width={600} height={450} className="rounded-lg shadow-light"/>
